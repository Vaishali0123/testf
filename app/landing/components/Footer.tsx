    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-24">
            ...
            >
              <div className="relative">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="sm:w-[50px] sm:h-[50px] transition-transform duration-300 hover:scale-110"
                />
              </div>
          ...
          {/* Right Section - Navigation Links */}
          <div
            className={`grid grid-cols-1  xs:grid-cols-2 gap-6 sm:gap-8 transform transition-all duration-1000 ease-out ${
              isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-8 opacity-0"
            }`}
