...
const PricingPage = () => {
  ...
  const getPrice = (basePrice: number, period: string, sites: number) => {
    let multiplier = period === "yearly" ? 10 : 1; // 2 months free on yearly
    let siteMultiplier = sites === 2 ? 1 : sites === 4 ? 1.8 : 3.2;
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300">
              Whether you're looking to build your portfolio, or find your next
              freelance client — we have a plan for you.
            </p>
          </div>
