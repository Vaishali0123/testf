          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              {recentBlogs.map((blog) => (
                <div
                  key={blog.id}
                  className="flex border bg-[#ffffff0f] rounded-2xl overflow-hidden hover:bg-gray-800 transition-colors group cursor-pointer"
                >
                  <div className="w-48  bg-gray-800 flex-shrink-0">
                    <img
                      src={blog.image}
                      alt={blog.title}
                      className="w-full h-full items-center flex text-center  justify-center bg-black object-cover"
                    />
                  </div>
