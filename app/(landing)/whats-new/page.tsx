    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2 sm:gap-4 relative z-10 w-full max-w-6xl">
          ...
          <div
            className={`flex flex-col sm:flex-row items-center gap-2 p-2 rounded-full mt-6 text-[14px] bg-black/60 sm:border border-white/5 transition-all duration-1000 delay-500 hover:scale-105 w-full max-w-[500px] mx-4 ${
