...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="text-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden"
    >
      <div
        className={`w-full p-8 py-10 rounded-3xl mx-auto backdrop-blur-lg border border-white/5 max-w-7xl relative transition-all duration-1000 ease-out ${
          isVisible
